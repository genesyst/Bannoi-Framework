...
{
    public partial class uc_sideTools : UserControl
    {
        #region properties
        ...
        private void setButtonWithStatus()
        {
            try
            {
                if (this.bnsdbStatus == dbStatus.dbAddNew || this.bnsdbStatus==dbStatus.dbUpdate
                    || this.bnsdbStatus == dbStatus.dbFilter || this.bnsdbStatus == dbStatus.dbInsert || this.bnsdbStatus == dbStatus.dbEdit)
                {
